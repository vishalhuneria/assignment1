...
const Header = () => {
  ...
  return (
    <header className=" w-[100%] bg-[#004733] bg-[url('https://media.better.com/better-com/homepage/hero-variant-c.webp')]  md:pt-0 pt-20 bg-[length:470px_510px] bg-bottom  bg-no-repeat  bg-custom-size[] md:h-dvh h-max  place-content-center">
      <div>
